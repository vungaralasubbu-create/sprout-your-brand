...
export const COMMAND_ITEMS: CommandItem[] = [
  ...
  { id: "admin-execution", label: "AI Execution Center", to: "/admin/execution", group: "nav", roles: ["admin", "founder"], icon: Zap, keywords: ["glintrai", "workflows", "automation", "execute", "approvals", "audit", "run", "launch course", "publish blog"] },
