...
export function BusinessHome() {
  ...
  const KPIS = [
    ...
    { icon: Users, label: "Students", value: 128, delta: "+6" },
    { icon: GraduationCap, label: "Active courses", value: 12 },
    { icon: TrendingUp, label: "Admissions this month", value: kpis?.leadsMonth ?? 34, delta: "+9" },
    { icon: Target, label: "Lead conversion", value: "18%" },
    { icon: Activity, label: "Website visits", value: "2.1k", delta: "+22%" },
    { icon: Search, label: "SEO score", value: "78/100" },
    { icon: Megaphone, label: "Marketing score", value: "84/100" },
    { icon: ClipboardList, label: "Unread messages", value: kpis?.unreadMessages ?? 0 },
